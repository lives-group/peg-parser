...
import sun.awt.font.CreatedFontTracker;
  ...
  // REMIND - need to update this for serialization
    public static Font createFont ( int fontFormat, InputStream fontStream )
      throws java.awt.FontFormatException, java.io.IOException {
        ...
        try {
            final File tFile = (File)AccessController.doPrivileged(
            ...
            try {
                final OutputStream outStream = (OutputStream)
                ...
                String name = null;
                try {
                    name = SunGraphicsEnvironment.createFont(tFile, tracker);
                } catch (Throwable t) {
                }
                if (name == null) {
                    if (tracker != null) {
                        tracker.subBytes((int)tFile.length());
                    }
                    AccessController.doPrivileged(
                        new PrivilegedExceptionAction() {
                            public Object run() {
                    ...
                    throw new FontFormatException("Not a valid font");
                }
                Font font = new Font(name, Font.PLAIN, 1, true);
                AccessController.doPrivileged(
                    new PrivilegedExceptionAction() {
                        public Object run() {
                            tFile.deleteOnExit();
